...
th = theme(panel.grid.major = element_blank(),
           ...
           strip.text.x = element_text(size = rel(1.8)))
kake = g+l+p+lab+f+theme_bw(base_family = "HiraKakuPro-W3")+th+theme(legend.position = 'none')+scale_x_continuous(breaks=seq(1972, 2020, by = 5), expand=c(0, 1))+scale_y_continuous(limits = c(0, 60))
...
th = theme(panel.grid.major = element_blank(),
           ...
           legend.title = element_text(size = rel(1.8)),
           strip.text.x = element_text(size = rel(1.8)))
niso = g+p+l+lab+f+theme_bw(base_family = "HiraKakuPro-W3")+ theme(legend.position = 'none')+th+theme(legend.position = 'none')+scale_x_continuous(breaks=seq(1972, 2020, by = 5), expand = c(0, 1))+scale_y_continuous(limits = c(0, 300))
...
th = theme(panel.grid.major = element_blank(),
           ...
           legend.title = element_text(size = rel(1.8)),
           strip.text.x = element_text(size = rel(1.8)))
tra = g+p+l+lab+f+theme_bw(base_family = "HiraKakuPro-W3")+ theme(legend.position = 'none')+th+theme(legend.position = 'none')+scale_x_continuous(breaks=seq(1972, 2020, by = 5), expand=c(0, 1))+scale_y_continuous(limits = c(0, 120))
...
th = theme(panel.grid.major = element_blank(),
           ...
           legend.title = element_text(size = rel(1.8)),
           strip.text.x = element_text(size = rel(1.8)))
w = g+p+l+lab+f+theme_bw(base_family = "HiraKakuPro-W3")+ theme(legend.position = 'none')+th+theme(legend.position = 'none')+scale_x_continuous(breaks=seq(min(w_cpue$year), max(w_cpue$year), by = 5), expand=c(0, 1))+scale_y_continuous(limits = c(0, 3))
